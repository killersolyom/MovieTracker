...
import com.movie.tv.Communication.VideoItemImplementation;
...
public class ExoVideoItemPresenter extends Presenter {

    private Context context;
    private VideoPlayerListenerInterface fragmentInterface;
    private VideoItemImplementation fragmentMethods;

    public ExoVideoItemPresenter(VideoPlayerListenerInterface mInterface) {
        fragmentInterface = mInterface;
        fragmentMethods = new VideoItemImplementation();
    }
    ...
    class PresenterViewHolder extends ViewHolder {
        ...
        private void initClickListener(MovieVideo video) {
            layout.setOnClickListener(view -> fragmentMethods.changeMovie(fragmentInterface, video));
        }
